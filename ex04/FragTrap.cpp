...
/*   Updated: 2024/09/23 19:50:19 by akovalev         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void FragTrap::highFivesGuys()
{
	...
	{
		std::cout << "FragTrap " << _name << " raises its hand to High Five!"<< std::endl;
	}
	else if (_energyPoints <= 0)
	{
		std::cout << "FragTrap " << _name << " is out of energy and cannot High any Fives!" << std::endl;
	}
	else if (_hitPoints <= 0)
	{
		std::cout << "FragTrap " << _name << " is out of hit points and cannot High any Fives!" << std::endl;
	}
}
